...
const SkillsList = () => {
  ...
  const skills = {
    "What technologies do I use?": [
      "I currently work with technologies like React, Next.js, Vue.js, Astro, Tailwind, Bootstrap and other libraries and frameworks for frontend development. On the backend, I work with Node.js, Express, MongoDB, Firebase, among others.",
    ],
    "My Experience": [
      "I have experience working in startups and technology consulting firms, developing and creating websites based on Figma designs. For this, I use frontend technologies like Astro and React, along with Tailwind CSS and other libraries and frameworks for styling and interface optimization.",
    ],
    "My Education": [
      "I studied a university degree in automation at ITU, which gave me the foundations in programming. Later, I decided to focus on web and software development at ITU. Additionally, I completed various courses, diplomas and certifications at major Argentine universities, such as UTN and Instituto Tecnológico Universitario. I also complement my education with self-learning, which allows me to stay updated with technological advances in software development.",
    ],
    "How do I work in a team?": [
      "I have experience working in multidisciplinary teams, where I have been responsible for frontend development of web applications. For this, I use agile methodologies such as Scrum and Kanban, as well as version control tools like Git and GitHub to manage the workflow. I also have experience using project management tools like Trello and Jira, facilitating organization and collaboration within the team.",
    ],
    "Agile Methodologies": [
      "I have worked with agile methodologies such as Scrum and Kanban. In Scrum, I participated in two-week sprints, where at the end of each sprint I would make a pull request (PR) with my work, which went through a review and correction phase before being merged and sent to production. I have also worked with Kanban, using boards to manage tasks and move them according to their progress status. Additionally, I participated in daily meetings (dailies) to plan and report project progress, ensuring efficient communication within the team.",
    ],
  };
