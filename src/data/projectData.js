...
export const proyectos = [
  {
    ...
    descripcion:
      "Full-stack app with CRUD functions, board and list creation, user authentication, developed with the MERN stack.",
    imagen: imgNote.src,
  ...
  {
    titulo: "Handcrafted Store",
    descripcion:
      "Full-stack e-commerce to view, buy, and sell your products, with login for users and sellers.",
    imagen:
  ...
  },
  {
    titulo: "Weather App",
    descripcion:
      "Application made with React that uses an API to show real-time weather.",
    imagen:
  ...
  },
  {
    titulo: "AstroFit",
    descripcion:
      "Website developed with Astro and Tailwind, marketing funnel for fitness consulting.",
    imagen: astroFit.src,
    tecnologias: ["Astro", "tailwind", "JavaScript"],
  ...
  },
  {
    ...
    descripcion: "100 projects, made with HTML, CSS, and JavaScript.",
    imagen:
  ...
  },
  {
    titulo: "PlaniFy",
    descripcion:
      "Web app to organize your projects, made with React + Vite, TypeScript, and Tailwind for styles.",
    imagen:
